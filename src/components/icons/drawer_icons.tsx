...
export const UserIcon = ({classes, size = 5}: IconsType) => {
    return (
        <svg className={`size-${size} ${classes}`} aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
...
export const ContainerIcon = ({classes, size = 5}: IconsType) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" className={`size-${size} ${classes}`} viewBox="0 0 256 256"
             fill="currentColor">
            <path
...
export const ClientIcon = ({classes, size = 5}: IconsType) => {
    return (
        ...
        <svg className={`size-${size} ${classes}`} fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"
