...
// @ts-expect-error
interface DrawerAccordionPropsType extends ComponentPropsWithoutRef<"div"> {
 ...
 *
 * @param {DrawerAccordionPropsType} props - The props for the Accordion component.
...
const DrawerAccordion = ({
    ...
    ...rest
}: DrawerAccordionPropsType): JSX.Element => {
