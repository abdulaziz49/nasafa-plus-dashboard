...
import Formkruck from '../../components/form_container.tsx';
...
const TruckManagementView = () => {
	...
	return (
		...
		<Formkruck classes="w-full h-auto bg-base-100">
                ...
                <form className="w-full h-auto p-1 lg:p-2">
                    ...
                    <div
                        ...
                        <InputField
                            name="kruck_name"
                            labelText={t('kruck-name-label')}
                            fieldType="text"
                            placeholder={t('kruck-code-placeholder')}
                            withLabel={true}
                        ...
                        <Select name="group_id"
                                labelText={t('kruck-group-label')}
                                // placeholder={t('kruck-group-placeholder')}
                                withLabel={true}
                                classes="w-full w-full lg:col-span-6">
