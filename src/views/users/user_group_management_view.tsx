...
const UserGroupManagementView = () => {
    return (
        <div className='h-dvh w-full flex flex-col items-center justify-center overflow-none p-3 lg:py-4 space-y-2'>
            {/*<section className='p-3 w-full'>*/}
                <FormContainer classes='w-full h-auto bg-base-100'>
                    <h1 className='text-2xl lg:text-4xl text-center font-bold mb-0.5 lg:mb-4'>User Group Management</h1>
                    <form className="w-full h-auto p-1 lg:p-2">
                        <div className='w-full h-auto flex flex-col lg:flex-row justify-evenly'>
                            <InputField name='group_name' labelText='Group Name' fieldType='text'
                                        ...
                                        withLabel={true} classes='w-full mb-3 lg:mb-0'/>
                            <Textarea name='group_description' placeholder='Group Description' withLabel={true}
                                      labelText='Group Description' classes='w-full'/>
                        </div>
                        <br/>
                        <div
                            ...
                            {/*<div className='w-1/3 flex flex-col lg:flex-row space-1 items-center justify-evenly'>*/}
                            {/*<Button classes='join-item btn-primary' clickEvent={()=>{}}>Save</Button>*/}
            ...
            {/*</section>*/}
                ...
                <Pagination/>
            {/*<section className='w-full h-dvh overflow-auto'>*/}
            {/*</section>*/}
        </div>
    )
}
