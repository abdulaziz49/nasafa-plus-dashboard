                ...
                <div className="card bg-base-300 lg:max-w-sm w-5/6 shrink-0 shadow-2xl">
                    <div className="card-body">
                        <div className='card-title flex justify-center mb-4'>
                            {/*Login now!*/}
                            <h1 className="text-3xl lg:text-4xl font-bold">{t('login-head')}</h1>
                        </div>
                        {/*<div className="divider"></div>*/}
                        <FormContainer>
                            <LocaleSwitcher />
                            <InputField fieldType='text' name='username' labelText={t('login-username')} withLabel={true}
                                        placeholder={t('login-username')} classes='w-auto mb-2'/>
